...
if ($is_member) {
    Html::alert('현재 로그인 중입니다.'.$layout_uri, $layout_uri . '/contents/list.html');
}
...
<div id="<?=$module?>">
    ...
    <div id="login_box">
		...
		<h3><img src="./img/h3_login.png" alt="Partner LOGIN" /></h3>
        ...
        <div class="form_box">
            ...
            <ul>
            <li class="login_id">
                <input type="text" name="login_id" id="login_id" value="<?=$ck_save_id?>" class="text required placeholder" size="20" maxlength="20" title="아이디" />
            </li>
            <li class="login_pw">
                <input type="password" name="login_pw" id="login_pw" class="text required placeholder" size="20" maxlength="20" title="비밀번호" />
            </li>
            </ul>
            ...
            <div class="auto_login">
                <input type="checkbox" name="flag_save_id" id="flag_save_id" value="1" <?if($ck_save_id) { ?>checked="checked"<? } ?> />
