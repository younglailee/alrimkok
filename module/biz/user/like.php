...
<section id="noti-list" class="contents">
    <div class="container">
        ...
        <div class="list-search pc">
            ...
            <form action="./like.html" method="get" name="search_form">
                <div class="sch-wrap tab-group">
                    ...
                    <div class="sch sch03">
                        ...
                        <div class="btt">
                            <div class="btn resetBtn" onclick="location.href='./like.html'">초기화</div>
        ...
        <div class="tab-group2">
            <ul class="list-tab tab">
                <li data-href="list">전체 공고</li>
                <li data-href="recommend">추천 공고</li>
                <li data-href="recent">최근 본 공고</li>
                <li class="active" data-href="like">찜한 공고</li>
            </ul>
                    ...
                    <?php for ($i = 0; $i < count($list); $i++) {
                        ...
                        <li class="list">
                            <a href="./view.html?bz_id=<?= $list[$i]['bz_id'] ?>">
                                ...
                                <p class="wish on" data-bz="<?=$list[$i]['bz_id']?>"></p>
                            </a>
                        </li>
                    <?php } ?>
                    <?php if($cnt_total < 1) {
