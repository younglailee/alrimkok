...
<section id="noti-list" class="contents">
    <div class="container">
        ...
        <div class="list-search pc">
            ...
            <form action="./recommend.html" method="get" name="search_form">
                <div class="sch-wrap tab-group">
                    ...
                    <div class="sch sch03">
                        ...
                        <div class="btt">
                            <div class="btn resetBtn" onclick="location.href='./recommend.html'">초기화</div>
        ...
        <div class="tab-group2">
            <ul class="list-tab tab">
                ...
                <li class="active" data-href="recommend">추천 공고</li>
