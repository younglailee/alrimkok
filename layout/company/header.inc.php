...
<div id="wrap">
    <div id="header">
        <h1>
            ...
            echo ($member['mb_level'] != 7) ? '<a href="' . $layout_uri . '/progress/list.html">' : '<a>';
            echo _HOMEPAGE_TITLE_ . ' ' . ucfirst($layout) . 'Mode';
            echo ($member['mb_level'] != 7) ? '</a>' : '</a>';
            ?>
        </h1>
        <h2 class="hidden">상단영역</h2>
        <ul class="header_qm">
        <li><a href="http://www.alpha-edu.co.kr/lms/plugin/login/?type=company" target="_blank" title="새창">구)LMS기업관리자</a></li>
    ...
    <div id="container">
        ...
        <div id="aside">
            <div class="member_info">
                <p>
                    <em><strong><?= $member['cp_name'] ?></strong></em>
                    환영합니다.<br/>
